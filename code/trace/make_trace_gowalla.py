...
class gen_trace_data:
    ...
    def load_checkins(self, filename, use_community):
        ...
        self.start_time = 1243785600 #2009-6-1
        self.end_time = 1275321600 #2010-6-1
...
if __name__ == "__main__":
    ...
    argpar.add_argument('-G', help="add 'full' to use full usernet, 'community' to generate a community")
    args = argpar.parse_args()
    if args.G == 'full':
        location_filename = "../socialnet/data/LBSN-Gowalla/loc-gowalla_totalCheckins.txt"
        os.system("mkdir -p ./data/traces/GowallaBigraph/")
        os.system("cp ../socialnet/data/LBSN-Gowalla/loc-gowalla_edges.txt ./data/traces/GowallaBigraph/relations.txt")
        relation_filename = "./data/traces/Gowalla/relations.txt"
        output_filename = "./data/traces/Gowalla/all_timeline.txt"
        trace_data = gen_trace_data(location_filename, relation_filename, output_filename)
        trace_data.launch(use_community=False)
        
    elif args.G == "community":
        location_filename = "../socialnet/data/LBSN-Gowalla/loc-gowalla_totalCheckins.txt"
        os.system("mkdir -p ./data/traces/GowallaBigraph/")
        os.system("mkdir -p ./data/traces/GowallaBigraphCommunity/")
        os.system("cp ../socialnet/data/LBSN-Gowalla/loc-gowalla_edges.txt ./data/traces/GowallaBigraph/relations.txt")
        relation_old_filename = "./data/traces/GowallaBigraph/relations.txt"
        relation_new_filename = "./data/traces/GowallaBigraphCommunity/relations.txt"
        output_filename = "./data/traces/GowallaBigraphCommunity/all_timeline.txt"
