...
if __name__ == '__main__':
    ...
    # g = sns.FacetGrid(df, col="Dataset", hue='CDN Layer', palette=color_list, col_wrap=2)
    ...
    for dataset in df['Dataset'].unique():
        ...
        # ax = sns.barplot(data=subset, x='Method', y='Network Traffic Volume (GB)', hue='CDN Layer', ax=axes[ax_position])
        subset = df[df['Dataset'] == dataset]
